...
// Thin wrapper over Recharts LineChart — keeps chart config DRY and theme-aware.
// When you need a new chart type, create a sibling file (BarChart, AreaChart) using the same pattern.
